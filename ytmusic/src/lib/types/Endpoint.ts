...
export type EndpointOf<T extends EndpointType> =
  T extends EndpointType.Browse ? BrowseEndpoint :
  T extends EndpointType.BrowseContinuation ? BrowseContinuationEndpoint :
  T extends EndpointType.Search ? SearchEndpoint :
  T extends EndpointType.SearchContinuation ? SearchContinuationEndpoint :
  T extends EndpointType.Watch ? WatchEndpoint :
  T extends EndpointType.WatchContinuation ? WatchContinuationEndpoint : null;

interface Endpoint {
  //Type: EndpointType;
  type: EndpointType.Browse | EndpointType.BrowseContinuation |
    EndpointType.Search | EndpointType.SearchContinuation | EndpointType.Watch | EndpointType.WatchContinuation;
