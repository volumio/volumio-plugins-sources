...
### Version 2.12.2
  ...
  * Plugin now checks for Internet connectivity before starting (tries to reach the Google webpage).  Some users are using machines that bring up the plugin before Volumio is connected to the network.
  #### Changes
