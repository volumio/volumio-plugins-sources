...
class BaseViewHandler {
        ...
        if (!__classPrivateFieldGet(this, _BaseViewHandler_models, "f")[type]) {
            ...
            switch (type) {
                ...
                case model_1.ModelType.Search:
                    ...
                    break;
                case model_1.ModelType.Video:
                    model = model_1.default.getInstance(model_1.ModelType.Video);
                    break;
                case model_1.ModelType.Root:
                    model = model_1.default.getInstance(model_1.ModelType.Root);
                    break;
                default:
        ...
        if (!__classPrivateFieldGet(this, _BaseViewHandler_renderers, "f")[type]) {
            ...
            switch (type) {
                ...
                case renderers_1.RendererType.Playlist:
                    ...
                    break;
                case renderers_1.RendererType.Video:
                    renderer = renderers_1.default.getInstance(renderers_1.RendererType.Video, __classPrivateFieldGet(this, _BaseViewHandler_uri, "f"), __classPrivateFieldGet(this, _BaseViewHandler_currentView, "f"), __classPrivateFieldGet(this, _BaseViewHandler_previousViews, "f"));
                    break;
                default:
    ...
    constructContinuationItem(data) {
        return {
            service: 'youtube2',
            type: 'item-no-menu',
            'title': data.continuation.text || YouTube2Context_1.default.getI18n('YOUTUBE2_MORE'),
            'uri': `${__classPrivateFieldGet(this, _BaseViewHandler_instances, "m", _BaseViewHandler_constructContinuationUri).call(this, data)}@noExplode=1`,
